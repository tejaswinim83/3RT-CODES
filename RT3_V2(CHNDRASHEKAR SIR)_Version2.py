...
def get_timestamped_filename(base_name: str, suffix: str) -> str:
    ...
    """
    filename = "GAGANYAN_{SESSION_TIMESTAMP}_{base_name}_{suffix}.csv"
    return filename
    ...
    try:
        ...
        if header_key.endswith(("A", "C", "E")):
           ...
           # Convert tracking values
            ...
            # Write to files
            write_to_SYN(
                [current_timestamp, SYS_Second, SYS_NanoSecond, SYS_WeekNumber],
                base_name + "_" + header_key
            )
            ...
            # Write to files
            write_to_SYN(
                [current_timestamp, SYN_Second, SYN_NanoSecond, SYN_WeekNumber],
                base_name + "_" + header_key
            )

        # Raw data always written
        write_to_raw(
            [current_timestamp, hexDecodedData],
            base_name + "_" + header_key
        )
